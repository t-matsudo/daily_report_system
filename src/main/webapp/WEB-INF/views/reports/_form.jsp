...
<lable for="${AttributeConst.REP_DATE.getValue() }">日付</lable><br/>
...
<textarea name="${AttributeConst.REP_CONTENT.getValue()}" id = "${AttributeConst.REP_CONTENT.getValue() }" rows ="10" cols="50"></textarea>
<br/>
<br/>
