            ...
            <tbody>
                ...
                <c:forEach var="report" items="${reports}" varStatus ="status">
                    ...
                    <tr class = "row${status.count %2 }">
                        ...
                        <td class = "report_action"><a href = "<c:url value ='?action=${actFol}&command=${commShow}&id=${report.id}'/>">詳細</a></td>
                </c:forEach>
            </tbody>
        </table>
        ...
        <div id = "pagination">
            ...
            <c:forEach var="i" begin = "1" end = "${((reports_count - 1)/ maxRow) + 1}" step="1">
                <c:choose>
                    ...
                    <c:when test="${id!=null}">
                        <a href = "<c:url value='?action=${actFol}&command=${commIdx}&page=${i}&id=${id}'/>"><c:out value ="${i}"/></a>&nbsp;
                    </c:when>
                    <c:otherwise>
